...
export const FAMILIAR_TEMPLATES: FamiliarTemplate[] = [
  ...
  },
  {
    ...
    name: 'Manager',
    creature: 'Steward',
    summary: 'Keeps the plan honest: who is doing what, by when, and what is slipping.',
    tierCount: 3,
  },
  {
    id: 'communicator',
    name: 'Communicator',
    creature: 'Herald',
    summary: 'Drafts for social media and the blog, and never publishes without a gesture.',
    tierCount: 3,
  },
];
