...
The lock now selects reviewed source `8c3d7354ca86cce864029d3586356eaaf07908f0`,
tree `34689f03042dee69d71f999114f569d9784e04a4`, including all 25 governed files
...
bytes, workflow bytes, protected environment, and artifact conventions. The
platform producer clones that reviewed Chat commit from the workflow checkout
before running observations or packaging, instead of trusting the triggering
checkout HEAD directly. A
...
| File | Bytes | SHA-256 |
| --- | ---: | --- |
| `.github/workflows/client-v1-conformance.yml` | 180,394 | `3d37a3c78e5bf741764b6a0604423decde75d5e4351139a3c286382477b487e2` |
...
| `scripts/phase1-schema-v2-producer.mjs` | 234,449 | `11b5a90250556e2709c078089be3251fd586bad60c9d16cdfd5d35151e36a3a2` |
