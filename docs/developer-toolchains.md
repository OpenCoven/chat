...
- This production-consumer preparation uses the fresh private SDK `0.0.1`
  ...
  Previous candidate evidence remains historical. Native production sources
  and the historical Phase 1 producer lock are unchanged; a separately
  reviewed producer integration and validator freeze are still required.
