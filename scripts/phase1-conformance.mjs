...
const publicPhase1DiagnosticIds = new Set([
  ...
  'phase1.native-scenarios.native-preflight',
  'phase1.native-scenarios.native-preflight-custody-rpc',
  'phase1.native-scenarios.native-preflight-custody-proof',
  'phase1.native-scenarios.native-preflight-installation-rpc',
  'phase1.native-scenarios.native-preflight-installation-secure-store-unavailable',
  'phase1.native-scenarios.native-preflight-installation-lock-unavailable',
  'phase1.native-scenarios.native-preflight-installation-entry-unavailable',
  'phase1.native-scenarios.native-preflight-installation-read-unavailable',
  'phase1.native-scenarios.native-preflight-installation-write-unavailable',
  'phase1.native-scenarios.native-preflight-installation-persistence-unavailable',
  'phase1.native-scenarios.native-preflight-installation-keychain-failure',
  'phase1.native-scenarios.native-preflight-installation-credential-missing',
  'phase1.native-scenarios.native-preflight-installation-response-rejected',
  'phase1.native-scenarios.native-preflight-installation-timeout',
  'phase1.native-scenarios.native-preflight-installation-transport-closed',
  'phase1.native-scenarios.native-preflight-installation-input-failed',
  'phase1.native-scenarios.native-preflight-installation-unexpected-type-error',
  'phase1.native-scenarios.native-preflight-installation-unexpected-error',
  'phase1.native-scenarios.native-preflight-installation-unexpected-value',
  'phase1.native-scenarios.native-preflight-installation-id',
  ...
  'phase1.native-scenarios.pairing-recovery',
  ...
  'phase1.native-scenarios.revocation-repair',
