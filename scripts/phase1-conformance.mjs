...
const publicPhase1DiagnosticIds = new Set([
  ...
  'phase1.native-scenarios.launch.discovery-not-found.publication.disabled-other',
  'phase1.native-scenarios.launch.discovery-not-found.publication.root-owner-unverified',
  'phase1.native-scenarios.launch.discovery-not-found.publication.root-owner-shared',
  'phase1.native-scenarios.launch.discovery-not-found.publication.target-owner-unverified',
  'phase1.native-scenarios.launch.discovery-not-found.publication.target-owner-shared',
  'phase1.native-scenarios.launch.discovery-not-found.publication.root-not-directory',
  'phase1.native-scenarios.launch.discovery-not-found.publication.root-symlink',
  'phase1.native-scenarios.launch.discovery-not-found.publication.target-not-file',
  'phase1.native-scenarios.launch.discovery-not-found.publication.endpoint-invalid',
